...
```mermaid
graph LR
    A[Vendor\nStripe, Shopify, GitHub, etc.] -->|Sends webhook| B[Relae Endpoint]
...
<div className="card" style={{ flex: "1", minWidth: "250px" }}>
  ...
  <div className="card__footer">
      ...
      <a href="/core-concepts/what-is-relae" className="button button--primary button--block">Learn More</a>
     </div>
...
<!--
  ...
  <div className="card" style={{flex: '1', minWidth: '250px'}}>
    ...
    <div className="card__footer">
      <a href="/api/authentication" className="button button--primary button--block">View API Docs</a>
    </div>
  </div>
-->
